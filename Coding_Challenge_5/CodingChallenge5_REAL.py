...
arcpy.env.workspace = r'C:\Data\Students_2022\Thomas\Coding_Challenge_5'
speciesList = []
...
for species in speciesList:
    ...
    fish = arcpy.CreateFishnet_management(out_Fishnet, origin, y_coord, cellX, cellY,
                                          '', '', opposite_corner, geometry_type="POLYGON",
                                          labels="NO_LABELS")
